...
function generatePoem(event) {
  ...
  let context =
    "You are a romantic poem and love to write poems. Make sure to follow the user instruction below and generate a poem that is not longer than couple paragraphs. Please separate each line with <br />. Sign the poem at the end with '-SheCodes AI'";
